...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion']) || empty($_POST['correo']) || empty($_POST['contraseña'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO cliente(nombre,telefono,direccion,correo,contraseña, usuario_id) values ('$nombre', '$telefono', '$direccion','$correo','$contraseña', '$usuario_id')");
            if ($query_insert) {
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese Contraseña" name="contraseña" id="contraseña" class="form-control">
                    </div>
