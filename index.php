...
<div class="container-fluid">
    <img src="assets/img/logo_tienda.png" width="125px" height="40px" alt="Logo" class="navbar-logo" />
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                    <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="cliente/assets/img/<?php echo $data['img']; ?>" alt="..." />
                            <!-- Product details-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto agregar" data-id="<?php echo $data['codproducto']; ?>" href="login.php">Agregar</a></div>
                            </div>
                        </div>
                    </div>
            <?php  }
